...
export const SCHEMA_KEY_TO_EXCEL_ATTR: Record<string, string> = {
  ...
  segment:             'SEGMENT',
  vendor_fabric_rate:  'VENDOR FABRIC RATE',
  value_add_acc_cost_type: 'VALUE ADD ACC. COST TYPE',
  value_add_cost:          'VALUE ADD ACC. COST',
  value_add_process_cost:  'VALUE ADD PROCESS COST',
...
export const SCHEMA_KEY_TO_DB_FIELD: Record<string, string> = {
  ...
  segment:              'segment',
  vendor_fabric_rate:   'vendorFabricRate',
  value_add_acc_cost_type: 'valueAddAccCostType',
  value_add_cost:          'valueAddCost',
  value_add_process_cost:  'valueAddProcessCost',
  age_group:               'ageGroup',
