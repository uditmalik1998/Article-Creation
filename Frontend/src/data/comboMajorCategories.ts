...
// Keep in sync with Backend/src/config/comboMajorCategories.ts.
// `majorCategory` stores the short SAP code, not the full name — e.g.
// "LW_KURTI_ST", "L_KURTI_ST", "IB_B_SUIT_FS", "JB_B_SUIT_ST_HS".
