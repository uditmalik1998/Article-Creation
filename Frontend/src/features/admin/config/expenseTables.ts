...
export const EXPENSE_TABLE_CONFIGS: Record<string, ExpenseTableConfig> = {
  ...
  'fabric-article-data': {
    ...
    columns: [
      ...
      { dataIndex: 'fabricArticleType', title: 'Article Type', editable: false, filterable: true },
  ...
  'body-article-data': {
    ...
    columns: [
      ...
      { dataIndex: 'bodyArticleType', title: 'Article Type', editable: false, filterable: true },
      { dataIndex: 'division', title: 'Division' },
      { dataIndex: 'subDivision', title: 'Sub Division' },
      { dataIndex: 'majorCategory', title: 'Major Category' },
      { dataIndex: 'mcCode', title: 'MC Code' },
  ...
  'basic-accessories': {
    title: 'Basic Accessories (Trims & Packaging Cost per Major Category)',
    description:
      'One row per major category from the "MAJ CAT WISE BASIC ACCESSORIES DETAILS" workbook — per-piece basic trims, packaging and thread cost. The per-accessory Qty/Rate breakdown behind these totals is maintained through the Excel upload on the Admin → Expenses page.',
    rowKey: 'id',
    ...
    columns: [
      ...
      { dataIndex: 'trimsTotal', title: 'Basic Trims Total (Rs/pc)', align: 'right' },
      { dataIndex: 'packagingTotal', title: 'Packaging Total (Rs/pc)', align: 'right' },
      { dataIndex: 'threadCost', title: 'Thread Cost (Rs/pc)', align: 'right' },
      { dataIndex: 'basicTrimsCost', title: 'Basic & Trims Cost (Rs/pc)', align: 'right' },
      { dataIndex: 'createdAt', title: 'Created At', type: 'date', editable: false },
      { dataIndex: 'updatedAt', title: 'Updated At', type: 'date', editable: false },
    ],
  },
